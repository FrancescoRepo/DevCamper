        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Housing = table.Column<bool>(nullable: false),
                    JobAssistance = table.Column<bool>(nullable: false),
                    JobGuarantee = table.Column<bool>(nullable: false),
                    AcceptGi = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bootcamps_Careers_CareerId",
                        column: x => x.CareerId,
                        principalTable: "Careers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bootcamps_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScholarshipsAvailable = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_CareerId",
                table: "Bootcamps",
                column: "CareerId");

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_Slug",
                table: "Bootcamps",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_Description",
                table: "Bootcamps",
                column: "Description",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_Phone",
                table: "Bootcamps",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_UserId",
                table: "Bootcamps",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamps_Website",
                table: "Bootcamps",
                column: "Website",
                unique: true);
